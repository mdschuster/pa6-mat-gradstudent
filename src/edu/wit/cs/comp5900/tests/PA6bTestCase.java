...
import edu.wit.cs.comp5900.PA6b;
import junit.framework.TestCase;

public class PA6bTestCase extends TestCase {
	...
	private void _testHasConsecutive(int[] a, int k, boolean expected) {
		Boolean result = null;
		try {
			result = PA6b.hasConsecutive(a, k);
		} catch (ExitException e) {}
