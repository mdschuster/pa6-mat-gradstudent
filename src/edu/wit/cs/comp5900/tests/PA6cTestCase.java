...
import edu.wit.cs.comp5900.PA6c;
import junit.framework.TestCase;

public class PA6cTestCase extends TestCase {
	...
	private void _testMatrixMultiply(int[][] m1, int[][] m2, int rE, int cE, String sE) {
		int[][] result = null;
		try {
			result = PA6c.matrixMultiply(m1, m2);
		} catch (ExitException e) {}
